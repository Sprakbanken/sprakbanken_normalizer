...
Y2 = (Y1 + CONJ_NO_WS + belowhundred).setParseAction(
    addfunc_no_ws
)  # nittenhundreogsekstiåtte
Y3 = (twothousand + CONJ_NO_WS + belowhundred).setParseAction(
    addfunc_no_ws
)  # totusenogfire
